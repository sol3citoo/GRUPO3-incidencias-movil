    ...
    Column(modifier = Modifier
        ...
        Row {
            ...
            Button(onClick = {
                ...
                viewModel.cargarUsuariosFiltrados(selectedId, selectedCorreo, selectedTipo)
            }) { Text("Cargar") }
        }
        ...
        LazyColumn(modifier = Modifier.weight(1f)) {
            items(usuarios) { usuario ->
                ...
                Row(
                    ...
                    Text(usuario.email, modifier = Modifier.weight(1f))
                    Text(usuario.rol, modifier = Modifier.width(120.dp))
                }
            }
        }
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            Button(
                onClick = { navController.navigate("detalleUsuario/CREAR") },
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(vertical = 4.dp)
            ) { Text("Crear usuario") }
        ...
        usuarioSeleccionado?.let { usuario ->
            if (mostrarDialogoBorrar) {
                AlertDialog(
                    ...
                    text = { Text("¿Borrar usuario ${usuario.email}?") },
                    confirmButton = {
                        Button(onClick = {
